...
function updatepathLanguage(pathLanguage) {
  if (pathLanguage) {
    pathLanguage.setAttribute("fill", "#d97706"); // Color fijo para el tema claro
  }
}
...
function updatePath(pathIcons) {
  if (pathIcons) {
    pathIcons.setAttribute("fill", "#d97706"); // Color fijo para el tema claro
  }
}
...
function updateFillSvg(svg) {
  if (svg) {
    svg.setAttribute("fill", "#78716c"); // Color para el tema claro
  }
}
